...
function(CREATE_PROTOBUF_WARNINGFREE_WRAPPERS HDR_OUT SRC_OUT)
    ...
    foreach(_FILE_PREFIX ${ARGN})
        ...
        configure_file(${CMAKE_SOURCE_DIR}/SIMDIS_SDK/CMakeImport/ProtobufFileWrapper.h.in ${_NEW_H} @ONLY)
        set_property(SOURCE ${_NEW_H} PROPERTY OBJECT_DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/${_FILE_PREFIX}.pb.h)
        configure_file(${CMAKE_SOURCE_DIR}/SIMDIS_SDK/CMakeImport/ProtobufFileWrapper.cpp.in ${_NEW_CPP} @ONLY)
